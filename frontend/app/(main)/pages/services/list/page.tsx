...
const ListServices = () => {
    ...
    //     return rowData.service == null ? '-' : rowData.service;
    // };
                ...
                <div className="col-12">
                    <div className="card">
                        ...
                        >
                            ...
                            <Column field="titulo" header="Título" filter filterPlaceholder="Search by name" style={{ minWidth: '12rem' }} />
                            {/* <Column field="titulo" header="Título" body={cidadeTemplate} filter filterPlaceholder="Search by name" style={{ minWidth: '12rem' }} /> */}
